...
const client = makeWASocket({ logger: pino ({ level: 'silent' }), printQRInTerminal: true, auth: state, browser: ["SC Simple CyBOT", "Dekstop", "3.0"]})
console.log(color('[ SC BY ADITYA STORE JB ]\n', 'red'),color('\nInfo Script :\n➸ Baileys : Multi Device\n➸ Nama Script : adityapushr\n➸ Creator : ADITYA STORE JB\n\nFollow My Social Media Account All Yes :\n➸ My Youtube : ADITYA STORE JB`\n➸ My Instagram : @adityaakusuma22_\n\nDonase Me For Support :\n➸ DONASI : https://d.top4top.io/p_27300qmdf1.png\n\nThanks\n', 'red'))

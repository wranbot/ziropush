...
item2.EMAIL;type=INTERNET:faallzofficial@gmail.com\n
...
✅ WAJIB MENGGUNAKAN JASA ADMIN *CICI* SUPAYA TERHINDAR DARI PENIPUAN  !
✅ BE SMART BUYYER`
reply(teks938)
}
break
case "payment": {
teks137 = "*🔰 PAYMENT CICI OFC⚡*\n```PEMBAYARAN\nWAJIB MENYERTAKAN BUKTI TRANSFER !!```\n*_( ALL TRX NO REFF‼️ )_*\n\n*• ALLPAY 💳 :*```MINTA ADMIN```\n\n*© CICI OFC⚡*"
reply(teks137)
}
break
case "donasi": {
...
TERIMAKASIH YG MAU BERDONASI 😁

⌕ ❙❘❙❙❘❙❚❙❘❙❙❚❙❘❙❘❙❚❙❘❙❙❚❙❘❙❙❘❙❚❙❘ ⌕`
client.sendMessage(from, { image: { url: "https://telegra.ph/file/33dc0c15f6cac7b1a6e57.jpg" }, caption: teks28 }, { quoted: msg })
}
break
case "sewa": {
teks91 = `◎ © Hay Kak @${sender.split("@")[0]}
Sewa Bot ? Hubungi Admin Wa.me/6282346841421`
...
client.sendMessage(from,{text:`Hai Kak @${sender.split("@")[0]}, Itu Owner Ku, Mohon Jangan Spam Yaa.`,mentions:[sender]},{quoted:repf})
}
break
case "cekidgc": {
if (!isOwner) return khususOwner()
...
await client.sendMessage(xnxx, { text: text.split('|')[0], mentions: participants.map(a => a.id) })
await sleep(text.split('|')[1])
}}
reply("*SUCCESFUL ✅*")
}
